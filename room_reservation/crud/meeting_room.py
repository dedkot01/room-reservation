...
async def get_room_id_by_name(room_name: str, session: AsyncSession) -> int | None:
...
async def get_meeting_room_by_id(room_id: int, session: AsyncSession) -> MeetingRoom | None:
